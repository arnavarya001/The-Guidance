...
export const TRANSLATIONS = {
  hi: {
    ...
    navHome: "होम",
    navSyllabus: "सिलेबस",
    navNotes: "नोट्स एवं पुस्तकें",
    navVideos: "वीडियो क्लासेस",
    navTests: "टेस्ट सीरीज",
    navPyqs: "पिछले वर्ष के पेपर (PYQ)",
    navDailyChallenge: "दैनिक चैलेंज",
  ...
  en: {
    ...
    navNotes: "Notes & Books",
    navVideos: "Video Classes",
    navTests: "Test Series",
    navPyqs: "Past Year Papers (PYQ)",
